 ...
 * denpendency on peripherals, index count from resource ahbp(0x400), each bit represents a peripheral
 * 0: no effect
 * 1: add periphera into this groupperiphera is needed
 */
 ...
 * denpendency on peripherals, index count from resource ahbp(0x400), each bit represents a peripheral
 * 0: no effect
 * 1: delete periphera in this groupperiphera is not needed
 */
 ...
 * LINK (RW)
 *
 * Affiliate groups of cpu0each bit represents a group
 * 0: no effect
