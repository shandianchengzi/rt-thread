...
struct rtgui_touch_device
{
    ...
    rt_uint16_t min_x, max_x;                   /*  X   */
    rt_uint16_t min_y, max_y;                   /*  Y   */

    struct rt_spi_device * spi_device;          /* SPI   */
...
{
    unsigned int touch_int_gpio = TOUCH_INT_PIN;     // 
