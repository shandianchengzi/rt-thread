...
typedef struct {
    ...
    __IO uint32_t RTCBKP_ISO;               //[0] 1 RTC    0 RTC

    __IO uint32_t RTCWKEN;                  //[0] 1 RTC
    ...
    __IO uint32_t PAWKSR;                   //Port A Wakeup Status Register1
...
#define SYS_CLKDIV_SYS_Pos          0       //  0 1    1 2
#define SYS_CLKDIV_SYS_Msk          (0x01 << SYS_CLKDIV_SYS_Pos)
#define SYS_CLKDIV_PWM_Pos          1       //PWM   0 1    1 8
#define SYS_CLKDIV_PWM_Msk          (0x01 << SYS_CLKDIV_PWM_Pos)
#define SYS_CLKDIV_SDRAM_Pos        2       //SDRAM 0 1    1 2    2 4
#define SYS_CLKDIV_SDRAM_Msk        (0x03 << SYS_CLKDIV_SDRAM_Pos)
#define SYS_CLKDIV_SDIO_Pos         4       //SDIO  0 1    1 2    2 4     3 8
...
#define SYS_CLKEN_ALIVE_Pos         31      //CHIPALIVE
...
#define SYS_RSTSR_BOD_Pos           1       //1 BOD1
#define SYS_RSTSR_BOD_Msk           (0x01 << SYS_RSTSR_BOD_Pos)
#define SYS_RSTSR_PIN_Pos           2       //1 1
#define SYS_RSTSR_PIN_Msk           (0x01 << SYS_RSTSR_PIN_Pos)
#define SYS_RSTSR_WDT_Pos           3       //1 WDT1
#define SYS_RSTSR_WDT_Msk           (0x01 << SYS_RSTSR_WDT_Pos)
#define SYS_RSTSR_SWRST_Pos         4       //Software Reset, 1 1
...
#define SYS_PLLDIV_ADDIV_Pos        9       //ADCVCOADDIVADC
#define SYS_PLLDIV_ADDIV_Msk        (0x1F << SYS_PLLDIV_ADDIV_Pos)
#define SYS_PLLDIV_ADVCO_Pos        14      //0 VCO16ADC    1 VCO32ADC    2 VCO64ADC
...
#define SYS_BODIE_2V2_Pos           1       //BOD 2.2V
#define SYS_BODIE_2V2_Msk           (0x01 << SYS_BODIE_2V2_Pos)

#define SYS_BODIF_2V2_Pos           1       //BOD 2.2V1
#define SYS_BODIF_2V2_Msk           (0x01 << SYS_BODIF_2V2_Pos)

#define SYS_ADC1IN7_SEL_Pos         0       //ADC171     2     3 RTCBG    4 BG   5 PDM33
#define SYS_ADC1IN7_SEL_Msk         (0x0F << SYS_ADC1IN7_SEL_Pos)
#define SYS_ADC1IN7_IOON_Pos        4       //ADC17IO
...
typedef struct {
    __IO uint32_t PORTA_SEL;                //PORTA_SEL[2n+2:2n]PORTA.PINnGPIO
                                            //PORTA_PINn_FUNMUXPORTA.PINnPORTA_MUX
...
#define TIMR_CTRL_EN_Pos            0       //1TIMRLDVAL
#define TIMR_CTRL_EN_Msk            (0x01 << TIMR_CTRL_EN_Pos)
#define TIMR_CTRL_CLKSRC_Pos        1       //0   1 
#define TIMR_CTRL_CLKSRC_Msk        (0x01 << TIMR_CTRL_CLKSRC_Pos)
#define TIMR_CTRL_CASCADE_Pos       2       //1 TIMRxTIMRx-1
...
#define TIMRG_PCTRL_EN_Pos          0       //320
...
#define UART_CTRL_BRKDET_Pos        15      //LIN Break DetectLIN BreakRX11
...
#define UART_CTRL_GENBRK_Pos        17      //Generate LIN BreakLIN Break
...
#define UART_BAUD_BRKIF_Pos         18      //LIN Break Detect LIN BreakBRKIE=1
...
#define SPI_STAT_RFLVL_Pos          9       //FIFO 0 RFF=1FIFO8 RFF=0FIFO0 1--7 FIFO1--7
...
typedef struct {
    __IO uint32_t CLKDIV;                   //[15:0] SCL5CLKDIV = SYS_Freq/5/SCL_Freq - 1
...
#define I2C_MSTCMD_WR_Pos           4       //    Slave1
#define I2C_MSTCMD_WR_Msk           (0x01 << I2C_MSTCMD_WR_Pos)
#define I2C_MSTCMD_RD_Pos           5       //Slave1  I2C1
#define I2C_MSTCMD_RD_Msk           (0x01 << I2C_MSTCMD_RD_Pos)
#define I2C_MSTCMD_BUSY_Pos         6       //START1STOP0
...
#define I2C_MSTCMD_RXACK_Pos        7       //SlaveACK0 ACK  1 NACK
...
#define ADC_CTRL_CONT_Pos           13      //Continuous conversion0 START
#define ADC_CTRL_CONT_Msk           (0x01 << ADC_CTRL_CONT_Pos)                         //   1 START
#define ADC_CTRL_TRIG_Pos           14      //0      1 PWM
...
#define ADC_START_GO_Pos            0       //1ADC0ADC
...
#define ADC_IF_CH0HFULL_Pos         2       //1
#define ADC_IF_CH0HFULL_Msk         (0x01 << ADC_IF_CH0HFULL_Pos)
#define ADC_IF_CH0FULL_Pos          3       //1
...
#define ADC_CTRL1_RIN_Pos           4       //0    1 105K   2 90K   3 75K   4 60K   5 45K   6 30K   7 15K
...
#define ADC_CTRL2_ADCEVCM_Pos       1       //ADC External VCMADCPGA
#define ADC_CTRL2_ADCEVCM_Msk       (0x01 << ADC_CTRL2_ADCEVCM_Pos)
#define ADC_CTRL2_PGAIVCM_Pos       2       //PGA Internal VCMPGA
...
#define ADC_CTRL2_REFPOUT_Pos       23      //1 ADC  1.2V REFPREFP1.2VREFP
#define ADC_CTRL2_REFPOUT_Msk       (0x01 << ADC_CTRL2_REFPOUT_Pos
#define ADC_CTRL2_CLKDIV_Pos        24      //HRC
...
typedef struct {
    __IO uint32_t MODE;                     //0 AB
                                            //1 ABPERAHIGHABADZADZBAB
                                            //2 
                                            //3 AB
                                            //4 
...
#define PWMG_ADTRG_EVEN_Pos         16      //1     0 
...
typedef struct {
    ...
    struct {
        ...
        __IO uint32_t SRCSGLEN;             //Scatter Gather
        ...
        __IO uint32_t DSTSGLEN;             //Scatter Gather
...
#define DMA_CR_LEN_Pos              0       //014096
...
#define DMA_AM_SRCAM_Pos            0       //Address Mode  0     1     2 scatter gather
...
typedef struct {
    ...
    union {
        struct {                            //
            ...
            __IO uint32_t AMR[4];           //Acceptance Mask Register, 0ID
...
#define CAN_BT0_BRP_Pos             0       //Baud Rate PrescalerCAN=2*Tsysclk*(BRP+1)
...
typedef struct {
    __IO uint32_t IE;                       //[0] 0IF[0]0

    __IO uint32_t IF;                       //[0] 11

    __IO uint32_t IM;                       //[0] 1LCDC

    __IO uint32_t START;

    __IO uint32_t SRCADDR;                  //20

    __IO uint32_t CR0;

    __IO uint32_t CR1;

    __IO uint32_t PRECMDV;                  //MPURS
} LCD_TypeDef;
...
#define LCD_CR0_VPIX_Pos            0       //portrait001767
                                            //portrait101767
#define LCD_CR0_VPIX_Msk            (0x3FF << LCD_CR0_VPIX_Pos)
#define LCD_CR0_HPIX_Pos            10      //portrait0011023
                                            //portrait1011023
#define LCD_CR0_HPIX_Msk            (0x3FF << LCD_CR0_HPIX_Pos)
#define LCD_CR0_DCLK_Pos            20      //0 DOTCLK    1 DOTCLK1
#define LCD_CR0_DCLK_Msk            (0x01 << LCD_CR0_DCLK_Pos)
#define LCD_CR0_HLOW_Pos            21      //HSYNCDOTCLK01
...
#define LCD_CR1_DCLKDIV_Pos         21      //DOTCLK0214 ...
#define LCD_CR1_DCLKDIV_Msk         (0x1F << LCD_CR1_DCLKDIV_Pos)
#define LCD_CR1_DCLKINV_Pos         26      //1 DOTCLKDOTCLK
...
#define SRAMC_CR_RWTIME_Pos         0       //014
#define SRAMC_CR_RWTIME_Msk         (0x0F << SRAMC_CR_RWTIME_Pos)
#define SRAMC_CR_BYTEIF_Pos         4       //SRAM0 16    1 8
#define SRAMC_CR_BYTEIF_Msk         (0x01 << SRAMC_CR_BYTEIF_Pos)
#define SRAMC_CR_HBLBDIS_Pos        5       //1 ADDR[23:22]   0 ADDR[23]ADDR[22]
...
typedef struct {
    ...
    __IO uint32_t NOPNUM;                   //[15:0] NOP

    __IO uint32_t LATCH;

    __IO uint32_t REFDONE;                  //[0] Frefresh Done
} SDRAMC_TypeDef;


#define SDRAMC_CR0_BURSTLEN_Pos     0       //2Burst Length4
...
#define SDRAMC_CR1_32BIT_Pos        18      //SDRAMC1 32bit    0 16bit
#define SDRAMC_CR1_32BIT_Msk        (0x01 << SDRAMC_CR1_32BIT_Pos)
#define SDRAMC_CR1_BANK_Pos         19      //SDRAMbank0 2 banks    1 4 banks
#define SDRAMC_CR1_BANK_Msk         (0x01 << SDRAMC_CR1_BANK_Pos)
#define SDRAMC_CR1_CELL32BIT_Pos    20      //SDRAM1 32bit    0 16bit
#define SDRAMC_CR1_CELL32BIT_Msk    (0x01 << SDRAMC_CR1_CELL32BIT_Pos)
#define SDRAMC_CR1_CELLSIZE_Pos     21      //SDRAM0 64Mb    1 128Mb    2 256Mb    3 16Mb
...
#define SDRAMC_LATCH_INEDGE_Pos     0       //SDRAM0     1 
#define SDRAMC_LATCH_INEDGE_Msk     (0x01 << SDRAMC_LATCH_INEDGE_Pos)
#define SDRAMC_LATCH_OUTEDGE_Pos    1       //SDRAM1     0 
...
#define NORFLC_CR_RDTIME_Pos        0       //Oen01
#define NORFLC_CR_RDTIME_Msk        (0x1F << NORFLC_CR_RDTIME_Pos)
#define NORFLC_CR_WRTIME_Pos        5       //Wen01
#define NORFLC_CR_WRTIME_Msk        (0x07 << NORFLC_CR_WRTIME_Pos)
#define NORFLC_CR_BYTEIF_Pos        8       //NOR FLASH1 8    0 16
#define NORFLC_CR_BYTEIF_Msk        (0x01 << NORFLC_CR_BYTEIF_Pos)

#define NORFLC_CMD_DATA_Pos         0       //PROGRAMDATANOR FLASHREADDATANOR FLASH
#define NORFLC_CMD_DATA_Msk         (0xFFFF << NORFLC_CMD_DATA_Pos)
#define NORFLC_CMD_CMD_Pos          16       //0 READ   1 RESET   2 AUTOMATIC SELECT   3 PROGRAM   4 CHIP ERASE   5 SECTOR ERASE
...
#define CRC_CR_IBITS_Pos            4       // 0 32    1 16    2 8
