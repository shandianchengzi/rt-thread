...
typedef struct {
    uint8_t  clksrc;        //RTC_CLKSRC_RC32KRTC_CLKSRC_XTAL32K
    uint16_t Year;
    uint8_t  Month;         //1--12
    uint8_t  Date;          //1--31
    uint8_t  Hour;          //0--23
...
typedef struct {
    uint8_t  Days;          //RTC_SUNRTC_MONRTC_TUERTC_WEDRTC_THURTC_FRIRTC_SAT
    uint8_t  Hour;
    uint8_t  Minute;
    uint8_t  Second;
    uint8_t  AlarmIEn;
...
typedef struct {
    ...
    uint8_t  Month;
    uint8_t  Date;
    uint8_t  Day;           //RTC_SUNRTC_MONRTC_TUERTC_WEDRTC_THURTC_FRIRTC_SAT
    uint8_t  Hour;
    uint8_t  Minute;
    uint8_t  Second;
} RTC_DateTime;
