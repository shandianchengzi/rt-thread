...
typedef struct {
    ...
    __IO uint32_t PAWKSR;                   //PORTA Wakeup Status1
    ...
    __IO uint32_t PRSTEN;                   //PRSTEN0x55PRSTR0PRSTR1
...
#define SYS_CLKSEL_IOFILT_Pos       6       //IO Filter0 HRC   2 XTAL   3 LRC
#define SYS_CLKSEL_IOFILT_Msk       (0x03 << SYS_CLKSEL_IOFILT_Pos)
#define SYS_CLKSEL_SDIO_Pos         10      //SDIO0 SYSCLK/2   1 SYSCLK/8   2 SYSCLK/4   3 SYSCLK
...
#define SYS_CLKSEL_AD0_Pos          16      //ADC0  0 HRC   1 XTAL   2 PLL
#define SYS_CLKSEL_AD0_Msk          (0x03 << SYS_CLKSEL_AD0_Pos)
#define SYS_CLKSEL_AD0DIV_Pos       18      //ADC0  0 1   1 1   2 4   3 8
...
#define SYS_CLKSEL_SLEEP_Pos        24      //  0 LRC   1 XTAL_32K
...
#define SYS_RTCWKSR_FLAG_Pos        0       //RTC1
#define SYS_RTCWKSR_FLAG_Msk        (0x01 << SYS_RTCWKSR_FLAG_Pos)

#define SYS_USBPHYCR_IDEN_Pos       0       //ID PIN
...
#define SYS_PRNGCR_MODE_Pos         1       //0    2 RCHFRCLFXTAH   3 RCHFRCLF
#define SYS_PRNGCR_MODE_Msk         (0x03 << SYS_PRNGCR_MODE_Pos)
#define SYS_PRNGCR_RDY_Pos          8       //1 PRNGDLPRNGDH
...
#define SYS_IOFILT_IOSEL_Pos        5       //IOIOFILTIO
...
#define SYS_BODCR_INTLVL_Pos        4       //BOD0 1.9v   1 2.1v   2 2.3v   3 2.5v   4 2.7v
#define SYS_BODCR_INTLVL_Msk        (0x07 << SYS_BODCR_INTLVL_Pos)
#define SYS_BODCR_RSTLVL_Pos        7       //BOD0 1.7v   1 1.9v   2 2.1v   3 2.7v
...
#define SYS_ADCCR_0IVRSEL_Pos       2       //ADC0 Internal Vref Select0    1 VDD33
#define SYS_ADCCR_0IVRSEL_Msk       (0x01 << SYS_ADCCR_0IVRSEL_Pos)
#define SYS_ADCCR_1IVRSEL_Pos       3       //ADC1 Internal Vref Select0    1 VDD33
#define SYS_ADCCR_1IVRSEL_Msk       (0x01 << SYS_ADCCR_1IVRSEL_Pos)
#define SYS_ADCCR_IVRFLT_Pos        4       //Internal Vref Filter0    1 
...
#define SYS_XTALSR_32KSTOP_Pos      0       //XTAL_32K Stop1
#define SYS_XTALSR_32KSTOP_Msk      (0x01 << SYS_XTALSR_32KSTOP_Pos)
#define SYS_XTALSR_STOP_Pos         1       //XTAL Stop1
...
#define SYS_ACMPCR_CMP0HYS_Pos      8       //CMP0 
...
#define SYS_ACMPCR_0NVREF_Pos       16      //1 ACMP0 NVREF
...
#define SYS_ACMPCR_CMP0IE_Pos       24      //CMP0 
...
#define SYS_ACMPCR2_HALL0_Pos       0       //1 ACMP0HALL0
...
#define SYS_ACMPCR2_VREF_Pos        3       //ACMPVREF 0.6 + 0.04*VREF
...
#define SYS_TEMPCR_AD0CH7_Pos       16      //ADC0 CH70    1 
...
typedef struct {
    ...
    __IO uint32_t DRVST;                    //0 4mA   1 8mA
} PORT_TypeDef;
...
#define PIN15   15
    ...
    __IO uint32_t INTBE;                    //Both EdgeINTLVLTRG10INTRISEEN
    ...
    __IO uint32_t DATAPIN0;                 //PIN0DATA32
...
typedef struct {
    __IO uint32_t HALLIE;                   //HALL

         uint32_t RESERVED;

    __IO uint32_t HALLIF;

    __IO uint32_t HALLEN;                   //HALL

    __IO uint32_t HALL0V;                   //HALL0Timer0 - 

    __IO uint32_t HALL3V;                   //HALL3Timer3 - 

         uint32_t RESERVED2;

    __IO uint32_t HALLSR;                   //HALL
...
#define TIMRG_HALLIE_HALL0_Pos      0       //HALL0HALL0Timer0
...
#define TIMRG_HALLIF_H0IN0_Pos      0       //HALL00
...
#define TIMRG_HALLIF_H3IN0_Pos      3       //HALL30
...
#define TIMRG_HALLEN_HALL0_Pos      0       //HALL0HALL0Timer0
...
#define TIMRG_HALLSR_H0IN0_Pos      0       //HALL00
...
#define TIMRG_HALLSR_H3IN0_Pos      3       //HALL30
...
#define UART_DATA_VALID_Pos         9       //DATA1
...
#define UART_CTRL_RXOV_Pos          5       //RX FIFO Overflow1
...
#define UART_BAUD_RXTHRF_Pos        19      //RX FIFO Threshold FlagRX FIFORXLVL >  RXTHR1
#define UART_BAUD_RXTHRF_Msk        (0x01 << UART_BAUD_RXTHRF_Pos)
#define UART_BAUD_TXTHRF_Pos        20      //TX FIFO Threshold FlagTX FIFOTXLVL <= TXTHR1
...
#define UART_BAUD_ABREN_Pos         23      //Auto Baudrate Enable1
#define UART_BAUD_ABREN_Msk         (0x01 << UART_BAUD_ABREN_Pos)
#define UART_BAUD_ABRBIT_Pos        24      //Auto Baudrate Bit0 1           0xFF
                                            //                                             1 210xFE
                                            //                                             1 430xF8
                                            //                                             1 870x80
#define UART_BAUD_ABRBIT_Msk        (0x03 << UART_BAUD_ABRBIT_Pos)
#define UART_BAUD_ABRERR_Pos        26      //Auto Baudrate Error0      1 
...
#define UART_FIFO_RXLVL_Pos         0       //RX FIFO LevelRX FIFO 
#define UART_FIFO_RXLVL_Msk         (0xFF << UART_FIFO_RXLVL_Pos)
#define UART_FIFO_TXLVL_Pos         8       //TX FIFO LevelTX FIFO 
#define UART_FIFO_TXLVL_Msk         (0xFF << UART_FIFO_TXLVL_Pos)
#define UART_FIFO_RXTHR_Pos         16      //RX FIFO ThresholdRX RXLVL >  RXTHR RX
#define UART_FIFO_RXTHR_Msk         (0xFF << UART_FIFO_RXTHR_Pos)
#define UART_FIFO_TXTHR_Pos         24      //TX FIFO ThresholdTX TXLVL <= TXTHR TX
...
#define UART_CTSCR_POL_Pos          2       //CTS0 CTS
...
#define UART_CFG_BRKTXLEN_Pos       2       //11bit13
#define UART_CFG_BRKTXLEN_Msk       (0x0F << UART_CFG_BRKTXLEN_Pos)
#define UART_CFG_BRKRXLEN_Pos       6       //01bit12
...
#define UART_TOCR_IFCLR_Pos         13      //TO Interrupt Flag Clear1
...
#define SPI_CTRL_SIZE_Pos           4       //Data Size Select, 3--154--16
...
#define SPI_CTRL_FAST_Pos           13      //1 SPI = SYS_Freq/2    0 SPISPI->CTRL.CLKDIV
#define SPI_CTRL_FAST_Msk           (0x01 << SPI_CTRL_FAST_Pos)
#define SPI_CTRL_DMATXEN_Pos        14      //1 DMAFIFO    0 MCUFIFO
#define SPI_CTRL_DMATXEN_Msk        (0x01 << SPI_CTRL_DMATXEN_Pos)
#define SPI_CTRL_DMARXEN_Pos        15      //1 DMAFIFO    0 MCUFIFO
...
#define SPI_CTRL_SSN_H_Pos          17      //0 SSN0         1 SSNSCLK
#define SPI_CTRL_SSN_H_Msk          (0x01 << SPI_CTRL_SSN_H_Pos)
#define SPI_CTRL_RFTHR_Pos          18      //RX FIFO Threshold0 FIFO1   ...   7 FIFO8
#define SPI_CTRL_RFTHR_Msk          (0x07 << SPI_CTRL_RFTHR_Pos)
#define SPI_CTRL_TFTHR_Pos          21      //TX FIFO Threshold0 FIFO0   ...   7 FIFO7
...
#define SPI_STAT_WTC_Pos            0       //Word Transmit Complete11
...
#define SPI_STAT_TFLVL_Pos          6       //FIFO 0 TFNF=0FIFO8TFNF=1FIFO0    1--7 FIFO1--7
#define SPI_STAT_TFLVL_Msk          (0x07 << SPI_STAT_TFLVL_Pos)
#define SPI_STAT_RFLVL_Pos          9       //FIFO 0 RFF =1FIFO8RFF =0FIFO0    1--7 FIFO1--7
...
#define SPI_IE_TFHF_Pos             4       //FIFO4
#define SPI_IE_TFHF_Msk             (0x01 << SPI_IE_TFHF_Pos)
#define SPI_IE_RFTHR_Pos            5       //FIFOCTRL.RFTHR
#define SPI_IE_RFTHR_Msk            (0x01 << SPI_IE_RFTHR_Pos)
#define SPI_IE_TFTHR_Pos            6       //FIFOCTRL.TFTHR
...
#define SPI_IF_WTC_Pos              8       //Word Transmit Complete1
#define SPI_IF_WTC_Msk              (0x01 << SPI_IF_WTC_Pos)
#define SPI_IF_FTC_Pos              9       //Frame Transmit CompleteWTCTX FIFOFTC
...
#define SPI_I2SPR_MCLKDIV_Pos       0       //Fmclk = Fpclk / (2 * (MCLKDIV + 1))MCLKSCLK256384
...
#define I2C_IF_TXE_Pos              0       //TX EmptyTXDATA
#define I2C_IF_TXE_Msk              (0x01 << I2C_IF_TXE_Pos)
#define I2C_IF_RXNE_Pos             1       //RX Not EmptyRXDATA
#define I2C_IF_RXNE_Msk             (0x01 << I2C_IF_RXNE_Pos)
#define I2C_IF_RXOV_Pos             2       //RX Overflow1
#define I2C_IF_RXOV_Msk             (0x01 << I2C_IF_RXOV_Pos)
#define I2C_IF_TXDONE_Pos           3       //TX Done1
#define I2C_IF_TXDONE_Msk           (0x01 << I2C_IF_TXDONE_Pos)
#define I2C_IF_RXDONE_Pos           4       //RX Done1
...
#define I2C_IF_MLTO_Pos             17      //Master SCL Low Timeout1
...
#define I2C_SADDR_MASK7_Pos         17      //7ADDR7 & (~MASK7) 
#define I2C_SADDR_MASK7_Msk         (0x7F << I2C_SADDR_MASK7_Pos)
#define I2C_SADDR_MASK10_Pos        16      //108
...
#define ADC_CR_DMAEN_Pos            4       //DMA0 CPUDATA_FIFO   1 DMADATA_FIFO
#define ADC_CR_DMAEN_Msk            (0x0F << ADC_CR_DMAEN_Pos)
#define ADC_CR_FFCLR_Pos            8       //FIFO Clear
#define ADC_CR_FFCLR_Msk            (0x0F << ADC_CR_FFCLR_Pos)

#define ADC_GO_SEQ0_Pos             0       //3
...
#define ADC_IE_SEQ0CMPMAX_Pos       4       //0COMP.MAX
#define ADC_IE_SEQ0CMPMAX_Msk       (0x01 << ADC_IE_SEQ0CMPMAX_Pos)
#define ADC_IE_SEQ0CMPMIN_Pos       5       //0COMP.MIN
...
#define ADC_IF_SEQ0CMPMAX_Pos       4       //0COMP.MAX
#define ADC_IF_SEQ0CMPMAX_Msk       (0x01 << ADC_IF_SEQ0CMPMAX_Pos)
#define ADC_IF_SEQ0CMPMIN_Pos       5       //0COMP.MIN
...
#define ADC_SR_EOC_Pos              0       //End Of ConversionADC
...
#define ADC_SR_LEVEL_Pos            5       //FIFO1~7FIFO1~7    0 FIFO Empty0FIFO Full8
...
#define ADC_SEQCHN0_SEQ0_Pos        0       //088bitxx0
...
#define ADC_SEQTRG_SEQ0_Pos         0       //00x01 CPU   0x02 TIMR2   0x03 TIMR3   0x04-07 ADC_TRIG0-3   0x10-1F PWM0A-PWM7B
...
#define ADC_SEQCOV_SEQ0_Pos         0       //00x00 1
...
#define ADC_SEQSMP_SEQ0_Pos         0       //00/1/2/3 1/2/4/8
...
#define PWM_BRKCR_OFFA_Pos          1       //A0    1 
...
#define PWM_BRKCR_OFFB_Pos          5       //B0    1 
...
#define PWM_BRKIN_BRK0A_Pos         0       //APWM_BRK0
...
#define PWM_OVFTRG_MUX_Pos          2       //Trigger0 trig[0]   1 trig[1]   2 trig[2]   ...   7 trig[7]
...
#define PWM_CMPTRG_MUX_Pos          17      //Trigger0 trig[0]   1 trig[1]   2 trig[2]   ...   7 trig[7]
#define PWM_CMPTRG_MUX_Msk          (0x07 << PWM_CMPTRG_MUX_Pos)
#define PWM_CMPTRG_WIDTH_Pos        20      //Trigger0    1 4   2 8   ...   63 252
...
#define PWM_CMPTRG_ATP_Pos          29      //AD0 0/8   1 1/8   ...   7 7/8
...
typedef struct {
    ...
    __IO uint32_t FILTER;                   //0    1 4PCLK   2 8PCLK   3 16PCLK
...
typedef struct {
    ...
    __IO uint32_t IE;                       //Interrupt Enable0IF

    __IO uint32_t IM;                       //Interrupt Mask0IF QEI_IRQn 
...
#define QEI_CR_ABSWAP_Pos           4       //1 AB
...
#define QEI_IE_MATCH_Pos            1       //POSCNTMAXCNTPOSCNTMAXCNT0
...
typedef struct {
    ...
    __IO uint32_t IE;                       //1IF[CHx]DMA10

    __IO uint32_t IM;                       //1IF[CHx]1dma_int1
...
#define DMA_CR_STEPOP_Pos           27      //Step Operation, 11
...
#define DMA_AM_DSTBURST_Pos         4       //0 Single    1 BurstInc4
...
typedef struct {
    ...
    struct {
        __IO uint32_t INFO;                 //BufferBuffer
    ...
    __IO uint32_t AMR[16];                  //Acceptance Mask Register, 0ID
} CAN_TypeDef;
...
#define CAN_SR_RXDA_Pos             0       //Receive Data AvailableFIFO
#define CAN_SR_RXDA_Msk             (0x01 << CAN_SR_RXDA_Pos)
#define CAN_SR_RXOV_Pos             1       //Receive FIFO OverrunFIFO
#define CAN_SR_RXOV_Msk             (0x01 << CAN_SR_RXOV_Pos)
#define CAN_SR_TXBR_Pos             2       //Transmit Buffer Release0     1 
...
#define CAN_IF_TXBR_Pos             1       //IE.TXBR=1SR.TXBR01
#define CAN_IF_TXBR_Msk             (0x01 << CAN_IF_TXBR_Pos)
#define CAN_IF_ERRWARN_Pos          2       //IE.ERRWARN=1SR.ERRWARNSR.BUSOFF 0-to-1  1-to-0
...
#define CAN_BT0_BRP_Pos             0       //Baud Rate PrescalerCAN=2*Tsysclk*((BT2.BRP<<6) + BT0.BRP + 1)
...
#define CAN_INFO_RTR_Pos            6       //Remote Frame1     0 
#define CAN_INFO_RTR_Msk            (0x01 << CAN_INFO_RTR_Pos)
#define CAN_INFO_FF_Pos             7       //Frame Format0     1 
...
#define SDIO_BLK_SIZE_Pos           0       //0x200 512   0x400 1024   0x800 2048
...
#define SDIO_CMD_RESPTYPE_Pos       16       //0     1 136    2 48    3 48Busy after response
...
#define SDIO_CMD_CMDINDX_Pos        24       //Command IndexCMD0-63ACMD0-63
...
#define SDIO_CR1_CDSRC_Pos          7       //Card Detect Source, 1 CR1.CDBIT    0 SD_Detect
...
#define SDIO_CR2_SDCLKDIV_Pos       8       //SDCLK Frequency Div, 0x00     0x01 2    0x02 4    0x04 8    0x08    16    ...    0x80 256
...
#define LCD_START_GO_Pos            1       //1
#define LCD_START_GO_Msk            (0x01 << LCD_START_GO_Pos)

#define LCD_CR_CLKDIV_Pos           0       //DOTCLK0213 ...
#define LCD_CR_CLKDIV_Msk           (0x3F << LCD_CR_CLKDIV_Pos)
#define LCD_CR_CLKINV_Pos           6       //1 DOTCLKDOTCLK
#define LCD_CR_CLKINV_Msk           (0x01 << LCD_CR_CLKINV_Pos)
#define LCD_CR_CLKALW_Pos           7       //DOTCLK Always1 DOTCLK    0 DOTCLK1
#define LCD_CR_CLKALW_Msk           (0x01 << LCD_CR_CLKALW_Pos)
#define LCD_CR_BURSTEN_Pos          8       //Burst Enable0 SINGLE   1 Burst
#define LCD_CR_BURSTEN_Msk          (0x01 << LCD_CR_BURSTEN_Pos)
#define LCD_CR_AUTORESTA_Pos        13      //Auto Restart1 
#define LCD_CR_AUTORESTA_Msk        (0x01 << LCD_CR_AUTORESTA_Pos)
#define LCD_CR_IMMRELOAD_Pos        14      //Immediate Reload
...
#define LCD_CR_BURSTLEN_Pos         21      //Burst Length0 Burst INCR4   1 Burst INCR8   2 Burst INCR16
#define LCD_CR_BURSTLEN_Msk         (0x03 << LCD_CR_BURSTLEN_Pos)

#define LCD_CRH_HSW_Pos             0       //Hsync Width, HSYNCDOTCLK01
#define LCD_CRH_HSW_Msk             (0xFF << LCD_CRH_HSW_Pos)
#define LCD_CRH_HBP_Pos             8       //01DOTCLK
#define LCD_CRH_HBP_Msk             (0xFF << LCD_CRH_HBP_Pos)
#define LCD_CRH_PIX_Pos             16      //011023
#define LCD_CRH_PIX_Msk             (0x3FF<< LCD_CRH_PIX_Pos)
#define LCD_CRH_HFP_Pos             26      //01DOTCLK
#define LCD_CRH_HFP_Msk             (0x3Fu<< LCD_CRH_HFP_Pos)

#define LCD_CRV_VSW_Pos             0       //Vsync WidthVSYNC01
#define LCD_CRV_VSW_Msk             (0xFF << LCD_CRV_VSW_Pos)
#define LCD_CRV_VBP_Pos             8       //01
#define LCD_CRV_VBP_Msk             (0xFF << LCD_CRV_VBP_Pos)
#define LCD_CRV_PIX_Pos             16      //011023
#define LCD_CRV_PIX_Msk             (0x3FF<< LCD_CRV_PIX_Pos)
#define LCD_CRV_VFP_Pos             26      //01
#define LCD_CRV_VFP_Msk             (0x3Fu<< LCD_CRV_VFP_Pos)

#define LCD_LCR_ALPHA_Pos           0       //BlendAlpha
...
typedef struct {
    ...
    struct {
        __IO uint32_t MAR;                  //Memory Address Registerword0
...
#define DAM2D_PFCCR_AMODE_Pos       8       //Alpha Mode, 0 Alpha   1 PFCCR.ALPHA   2 AlphaPFCCR.ALPHA
...
typedef struct {
    __IO uint32_t TIM;                      //SDRAM

    __IO uint32_t CFG;

    __IO uint32_t T64;                      //64ms
...
#define SDRAMC_CFG_HIGHFREQ_Pos     2       //SDRAM66MHz
...
typedef struct {
    ...
    __IO uint32_t INPUT;                    //CORDICSINCOS
                                            //ARCTANINPUT
                                            //  (0.05, 0.5]2INPUT
                                            //  (0.5, 2]   INPUT
                                            // > 2           2INPUT
...
#define CORDIC_CMD_SINCOS_Pos       3       //1 SINCOS    0 ARCTAN
#define CORDIC_CMD_SINCOS_Msk       (0x01 << CORDIC_CMD_SINCOS_Pos)
#define CORDIC_CMD_MULDIV_Pos       4       //0 SIN\COS\ARCTANSINCOS   2    3 
...
#define CORDIC_INPUT_F2_Pos         16      //SINARCTAN
#define CORDIC_INPUT_F2_Msk         (0x3FFF << CORDIC_INPUT_F2_Pos)
#define CORDIC_INPUT_I2_Pos         30      //SINARCTAN
...
#define CORDIC_IF_ERR_Pos           1       //1 SINCOS[0, 1]ARCTAN[0, 2]1
...
#define FMC_ERASE_ADDR_Pos          0       //4K
...
typedef struct {
    ...
    __IO uint32_t ADDR;
    __IO uint32_t DATA;
    __IO uint32_t CMDAHB;                   //AHBFlash
    __IO uint32_t CMD;                      // Flash
} SFC_TypeDef;                              //Serial Flash Controller


#define SFC_CFG_CMDTYPE_Pos         0       //0 WIP
                                            //1 1WIP88
                                            //2 3WIPIdentification
                                            //3 2WIPMIDDID
                                            //4 WIP
                                            //5 WIP
                                            //6 2WIP16
...
#define DAC_CR_DHRFMT_Pos           9       //DHR Format, 0 12DHR[11:0] => DOR[11:0]   1 12DHR[15:4] => DOR[11:0]   3 8DHR[7 :0] => DOR[11:4]
...
typedef struct {
    ...
    __IO uint32_t INIVAL;                   //CR.EN1INIVALRESULT
...
#define RTC_DATHUR_DATE_Pos         5       //date of month1--31
#define RTC_DATHUR_DATE_Msk         (0x1F << RTC_DATHUR_DATE_Pos)

#define RTC_MONDAY_DAY_Pos          0       //day of week0--6
...
#define RTC_TRIM_ADJ_Pos            0       //BASECNT32768DEC132768-ADJ32768+ADJ
#define RTC_TRIM_ADJ_Msk            (0xFF << RTC_TRIM_ADJ_Pos)
#define RTC_TRIM_DEC_Pos            8
#define RTC_TRIM_DEC_Msk            (0x01 << RTC_TRIM_DEC_Pos)

#define RTC_TRIMM_CYCLE_Pos         0       //INC1n(32768ADJ)+1,(32768ADJ)-1
                                            //cycles=0cycles=1n2cycles=7n8
...
#define WDT_CR_WINEN_Pos            3       // 
#define WDT_CR_WINEN_Msk            (0x01 << WDT_CR_WINEN_Pos)
#define WDT_CR_CKDIV_Pos            8       // 0 2   1 4   2 8 ...
...
#define USBD_DEVIF_SETCFG_Pos       0       //Set when receive Set Configuration command1
...
#define USBH_PORTSR_CLRENA_Pos      0       //Write: Clear Port Enable, 1PORTSR.ENA
...
#define USBH_PORTSR_CLRSUSP_Pos     3       //Write: Clear Suspend Status, 1PORTSR.SUSPInitiate Resume
...
#define USBH_PORTSR_CLRPOWER_Pos    9       //Write: Clear Port Power status, 1PORTSR.POWER
#define USBH_PORTSR_CLRPOWER_Msk    (0x01 << USBH_PORTSR_CLRPOWER_Pos)
#define USBH_PORTSR_CONNCHG_Pos     16      //1 PORTSR.CONN changed1
#define USBH_PORTSR_CONNCHG_Msk     (0x01 << USBH_PORTSR_CONNCHG_Pos)
#define USBH_PORTSR_ENACHG_Pos      17      //1 PORTSR.ENA changed1
#define USBH_PORTSR_ENACHG_Msk      (0x01 << USBH_PORTSR_ENACHG_Pos)
#define USBH_PORTSR_SUSPCHG_Pos     18      //set when a full Resume sequence is finished1
#define USBH_PORTSR_SUSPCHG_Msk     (0x01 << USBH_PORTSR_SUSPCHG_Pos)
#define USBH_PORTSR_RSTCHG_Pos      20      //set at the end of the Port Reset signal1
...
#define USBH_OTGCSR_SRSCHG_Pos      1       //Session Request Status Change,  set to 1 on Session Request Success, 1
...
#define USBH_OTGCSR_HNSCHG_Pos      3       //Host Negotiation Status Change, set to 1 on Host Negotiation Success1
...
#define USBH_OTGCSR_SRDCHG_Pos      5       //Session Request Detected Change, set to 1 when a Session Request is detected1
...
#define USBH_OTGCSR_HNDCHG_Pos      7       //Host Negotiation Detect Change, set to 1 when a Host Negotiation is detected, 1
...
#define USBH_OTGCSR_IDCHG_Pos       9       //set when OTGCSR.ID changed, 1
...
#define JPEG_CR_START_Pos           0       //JPEG DEC frame start
...
#define JPEG_CR_RESET_Pos           3       //JPEG DEC core reset
